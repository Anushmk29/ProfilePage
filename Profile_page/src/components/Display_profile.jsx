...
const Display_profile = () => {
  ...
  return (
    <>
      <div className=" bg-slate-200 w-full h-full xsm:w-full sm:w-full s=md:w-full lg:w-full flex flex-col  items-center p-5 m-0  overflow-y-hidden">
        {/*  display div */}
        ...
        <div className=" bg-slate-100 h-1/2 w-4/5 xsm:w-4/5 sm:w-4/5 md:w-4/5 lg:w-4/5 flex  justify-evenly  p-5 rounded-xl  shadow-xl gap-5">
          ...
          <div className="flex justify-between gap-10 bg-zinc-100 w-full h-full xsm:w-full sm:w-full m-3  rounded-xl  p-4 border-blue-400 border-2">
            <div className=" flex flex-col justify-evenly  gap-3 w-full h-full rounded-xl  p-2 ">
              ...
              <h3 className="font-bold font-serif mr-2 text-base">
                Course Name:{" "}
                <span className="font-normal p-3">{CourseName}</span>
              </h3>
              <h3 className="font-bold font-serif mr-2 text-base">
                University name:{" "}
                <span className="font-normal p-3">{UniversityName}</span>
              </h3>
              <hr />
              <h3 className="font-bold font-serif mr-2 text-base">
                Current Locaion:{" "}
                <span className="font-normal p-3">{CurrentLocation}</span>
              </h3>
              <h3 className="font-bold font-serif mr-2 text-base">
                Gender: <span className="font-normal p-3">{Gender}</span>
              </h3>
              <h3 className="font-bold font-serif mr-2 text-base">
                Birtday:<span className="font-normal p-3">{DOB}</span>
              </h3>
            </div>
            <div className="">
              <button>
        ...
        <div className=" h-full flex flex-row w-4/5  gap-6 xsm:w-4/5 sm:w-4/5 md:w-4/5 lg:w-4/5 ">
          <div className=" flex flex-col h-4/5 w-1/5 sm:w-2/5 md:w-2/5 lg:w-2/5 xsm:w-2/5 border-solid rounded-xl bg-slate-50 shadow-lg sticky top-5 ">
